...
import { testAuthPage, LoginPage, SingleProduct, Cart, Home, Checkout, Navbar, SingleOrder, AllOrders, ProductsList, NewUserRegistration } from '../index';
      ...
      <>
        <HashRouter>
          ...
          <Switch>
            ...
            <Route exact path='/orders/viewall' component={AllOrders} />
